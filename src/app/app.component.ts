...
export class AppComponent {
  public appPages = [
    ...
    { title: 'Clientes', url: 'customer', icon: 'paper-plane' },
    { title: 'Presupuestos', url: 'budget', icon: 'heart' },
    { title: 'Facturas', url: 'bills', icon: 'archive' },
    //{ title: 'Trash', url: '/folder/trash', icon: 'trash' },
    //{ title: 'Spam', url: '/folder/spam', icon: 'warning' },
  ];
  public labels = ['Pagado', 'Pendiente'];
  constructor() {
